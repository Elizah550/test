  ...
  return (
    <div>
      ...
      <Box w="70%" margin="auto">
        ...
        <Text fontSize="15px" textAlign="left" mt="1">
          Ikan allows you to hire a rental or self-drive car of your choice
          ...
          use Ikan to pick the car that is suited for your needs. For
          ...
          the city. Ikan provides you with the joy of driving a car, without
        ...
        <Text fontSize="15px" textAlign="left" mt="1">
          Ikan provides you with a car on rent in {location!=="" ? location : "BANGLORE"} without a driver.
          Book your car conveniently through online booking or on your
          smartphone. The vehicles have all-India permits, and Ikan provides
        ...
        <Text fontSize="15px" textAlign="left" mt="1">
          ...
          breakdowns! Ikan has enabled driving convenience for travellers
          around the country and is fst expanding its reach to cities including
          Ahmedabad, Bangalore, Chandigarh, Chennai, Coimbatore, Delhi-NCR,
          Hyderabad, Jaipur, Kochi, Kolkata, Ludhiana, Mangalore, Mumbai,
          Mysore, Pune, Siliguri and Vizag. Self-drive cars from Ikan have
          given customers more control, privacy, and freedom. Book a self-drive
          car in any city you visit with the Ikan app on your phone and feel
      ...
      <Image
        m="5"
        src="https://www.Ikan.com/build/6b51f1464b17dbb1d002f16e26572662.png"
        alt="tagline"
        maxH="200px"
      />
      </Box>
      <Text align="center" mt="5" mb="2" fontSize="12px">
        © Copyright 2023 IKAN India Private Ltd. All rights reserved
      </Text>
    </div>
  );
}
